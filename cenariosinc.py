...
def move_producers_to_table(t,platecount):
	...
	prato = canvas.create_image(490,50-(3*platecount),image = peixe)
	pratos.append(prato)
	time.sleep(1)
...
#Text View
#Text View
text_id= canvas.create_text(100, 20, anchor="nw", font="Arial 20")
canvas.itemconfig(text_id, text="Semaphore Sync Scenery")
